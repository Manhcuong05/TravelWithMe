    ...
    CommandLineRunner initDatabase(TourRepository repository) {
        return args -> {
            ...
            repository.save(Tour.builder()
                    ...
                    .price(15500000)
                    .durationDays(4)
                    .imagesJson("[\"/tours/danang.png\"]")
                    .build());

            System.out.println("DEBUG: Seeder Data updated with real high-quality images.");
        };
    }
}
